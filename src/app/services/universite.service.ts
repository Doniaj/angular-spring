...
export class UniversiteService {
  ...
  affecterUniversiteAFoyer(idFoyer: number, nomUniversite: string): Observable<any> {
    const url = `${this.apiUrl}/affecter-universite-a-foyer/${idFoyer}/${nomUniversite}`;
  ...
  affecterFoyerAUniversite(idFoyer: number, nomUniversite: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/affecterFoyer/${idFoyer}/${nomUniversite}`, {});
  }
